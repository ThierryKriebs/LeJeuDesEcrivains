...
function rafraichirTableauListeJoueurs()
{
    ...
    .then (data => {
        ...
        document.getElementById("idListeJoueur").innerHTML= "<div class='divDemarragePartiMulti'>" + tableauJoueurEntete+ tableauJoueurCorps + tableauJoueurFin + "</div> <BR>"+ data;
