...
async function demandeInfosSurpartieAuBackend() {
   ...
   try {
         ...
         //Vérification
         if (numeroEpreuve != data.numeroEpreuve || epreuveEtat != data.epreuveEtat || typeInfo != data.typeInfo) {
            ...
            if (data.erreur !== "")
            {
               ...
               if (typeInfo === "salleAttenteDebutNotation") {
                  delay = data.dureeRestanteAvDebNotation;
               }
