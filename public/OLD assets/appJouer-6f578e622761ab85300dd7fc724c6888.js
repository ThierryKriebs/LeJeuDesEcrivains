...
async function demandeInfosSurpartieAuBackend() {
   ...
   try {
         ...
         //Vérification
         console.log("data.flagRedacsTerminees: '" + data.FlagRedacsTerminees + "'")
         console.log("flagRedacsTerminees: '" + FlagRedacsTerminees + "'")
         console.log("FlagNotationsTerminees: '" + FlagNotationsTerminees + "'")
         console.log("codeConnexion: '" + codeConnexion + "'")
